...
/**
 * a helper class +vector
 * same thing twice - overloading ex: setLocation
 ...
 * @version 2.1
 */
public abstract class SmoothMover extends Actor //abstract - cant add the object. holds the information. 
{
    private Vector movement;
    private double exactX; // decinal #
     ...
     */
    public void setLocation(double x, double y) // asking for doubles. casting cuts the tail of an a decimal
    {
        exactX = x;
        exactY = y;
